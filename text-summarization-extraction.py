...
#example of python extractive text summarization: https://github.com/luisfredgs/extractive-text-summarization 
#run in a virtual environment with python3.9,  nltk, and bs4 installed
#command is "python3.9 text-summarization-extraction.py"
